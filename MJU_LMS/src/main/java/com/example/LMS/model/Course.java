...
public class Course {
	...
	private String lecture_professor_name;
	private String lecture_professor_id;
	...
	public String getLecture_professor_name() {
		return lecture_professor_name;
	}
	public void setLecture_professor_name(String lecture_professor_name) {
		this.lecture_professor_name = lecture_professor_name;
	}
	public String getLecture_professor_id() {
		return lecture_professor_id;
	}
	public void setLecture_professor_id(String lecture_professor_id) {
		this.lecture_professor_id = lecture_professor_id;
	}
